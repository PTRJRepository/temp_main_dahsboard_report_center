...
const RJFM_BASE = process.env.RJFM_BASE_URL
  // Monolith default: API hidup di proses yang sama (port 8011).
  || `http://127.0.0.1:${process.env.RJFM_API_PORT || process.env.PORT || '8011'}`
