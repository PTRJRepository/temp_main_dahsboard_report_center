...
import { adminAuthRoutes } from "./api/adminAuthRoutes";
...
import { downtimeRoutes, assetHealthRoutes } from "./api/downtimeRoutes";
...
const app = new Elysia()
    ...
    .use(authRoutes)
    // Admin Auth routes: /admin/auth/users, /admin/auth/roles, etc.
    .use(adminAuthRoutes)
