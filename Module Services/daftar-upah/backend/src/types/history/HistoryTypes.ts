...
export interface HistoryMetadata {
    id?: number;
    history_id: string;
    operation: 'CREATE' | 'DELETE' | 'UPDATE' | 'LOCK' | 'UNLOCK' | 'ARCHIVE' | 'RESTORE';
    entity_type: 'BATCH' | 'ROW' | 'DIVISION' | 'GANG' | 'PAYROLL_MASTER' | 'PAYROLL_DETAIL' | 'TASKREG' | 'ADTRANS' | 'GANG_MEMBER';
    entity_id?: number;
    period_month: number;
    period_year: number;
    division_code?: string;
