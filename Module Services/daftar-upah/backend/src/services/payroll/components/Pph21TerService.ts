...
// ponytail: export name collides with the core engine's pph21TerService
// (services/pph21TerService.ts). This is the component-registry adapter;
// renamed to pph21TerComponent so importers can't mix the two shapes up.
export const pph21TerComponent = new Pph21TerService();
