...
// Bypass file load by patching prototype to use fixture — save original for restoration
const proto = PremiumDefinitionService.prototype as any;
const origLoad = proto.loadDefinitions;
const patchedLoadDefinitions = function (this: PremiumDefinitionService) {
...
beforeAll(() => {
    proto.loadDefinitions = patchedLoadDefinitions;
});

afterAll(() => {
    proto.loadDefinitions = origLoad;
});
