...
// Override Config.API_KEY_BYPASS directly instead of process.env —
// Config is static readonly and may already be cached by another test file.
const ORIG_API_KEY_BYPASS = Config.API_KEY_BYPASS;
(Config as any).API_KEY_BYPASS = "test-manual-adjustment-api-key";
...
describe("manual adjustment by-api-key route", () => {
    afterAll(() => {
        (Config as any).API_KEY_BYPASS = ORIG_API_KEY_BYPASS;
