...
import {
    ...
    Wallet, Scale, Activity, Wrench, Truck, LineChart
} from 'lucide-react';
...
const DashboardLayout = () => {
    ...
    const navItems = [
        ...
        { section: 'Asset & Downtime', items: [
            { to: '/downtime/command-center', icon: Wrench, label: 'Downtime Command Center', description: 'Unit down, stage, blocker, ETA' },
            { to: '/downtime/analytics', icon: LineChart, label: 'Downtime Analytics', description: 'KPI, trend, pareto, MTTR/MTBF' },
            { to: '/asset-health', icon: Truck, label: 'Asset Health View', description: 'Visual schematic + hotspot komponen' },
        ]},
    ];
