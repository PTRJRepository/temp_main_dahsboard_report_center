                ...
                <div style={{ padding: 20, overflowY: 'auto', flex: 1, minHeight: 0 }}>
                    <div style={{ display: 'flex', flexDirection: 'column', gap: 10, marginBottom: 16 }}>
                        {isLegacyFallback ? (
                            ...
                            <div style={infoPanelStyle}>
                                {canEdit
                                    ? 'Total detail terbaru akan dipakai saat simpan.'
                                    : 'Mode lihat saja. Detail dibaca dari payroll_manual_adjustments metadata_json.'}
                            </div>
                        )}

                        <div style={summaryGridStyle}>
                            <div style={latestSummaryCellStyle}>
                                <div style={{ fontSize: 11, color: '#15803d', fontWeight: 700 }}>Total detail terbaru</div>
