...
export const METRICS = {
    ...
    cost_per_hk: {
        label: 'Cost / HK',
        // [HK-KEHADIRAN] Divisor HANYA HK kehadiran (hari hadir), bukan jumlah_hk
        formula: 'total_upah ÷ HK hadir (hari_kerja_efektif = jumlah_hk − libur_minggu − libur_nasional)',
        column: 'total_hari_kerja / hari_kerja_efektif',
        scope: SCOPE.PANEN,
        basis: 'unit',
        caveat: 'Angka HK yang dipakai: hari_kerja_efektif (hari hadir). HK libur = jumlah_hk − HK hadir. Dipakai deteksi lonjakan wage.'
    },
    total_premi: {
        label: 'Total Premi',
    ...
    upah_kotor_per_hk: {
        label: 'Upah Kotor / HK',
        formula: 'total_upah_kotor ÷ HK hadir (hari_kerja_efektif)',
        column: 'total_upah_kotor, total_hari_kerja / hari_kerja_efektif',
        scope: SCOPE.PANEN,
        basis: 'unit',
        caveat: 'HK dipakai: hari_kerja_efektif = jumlah_hk − libur_minggu − libur_nasional (hari hadir). JANGAN jumlah_hk / total_hk. HK libur = jumlah_hk − HK hadir (semua tidak hadir). Pembanding cost/ton: bila cost/HK naik tapi cost/ton turun → produktivitas membaik.'
    }
};
