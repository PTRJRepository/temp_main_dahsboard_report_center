      ...
      <div className="wsp-action-bar no-print">
        <div className="left-section">
          ...
          <div className="wsp-filter-group" style={{ display: 'flex', gap: '0.5rem' }}>
            ...
            <select value={division} onChange={e => setDivision(e.target.value)} className="wsp-select" style={{ minWidth: '150px' }} disabled={isLockedMode}>
              {!isLockedMode && <option value="ALL">SEMUA DIVISI</option>}
